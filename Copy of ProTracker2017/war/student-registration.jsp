...
<link href="live.png" type="image/png" rel="stureg" />
			...
			<div class="panel panel-primary">
				<div class="panel-body">
					<form method="post" action="Servlet1" id="f1" name="f1">
                        ...
                        <div class="form-group">
 							<input id="rolls" name="rolls" type="text" maxlength="50" class="form-control" placeholder="Enter register number" pattern="[0-9]{12,12}" required>
						</div>
                        <div class="form-group">
 							<input id="names" name="names" type="text" maxlength="50" class="form-control" placeholder="Enter your name" pattern="[a-zA-Z]{3,50}" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
 							<input id="title" name="title" type="text" maxlength="25" class="form-control" p length="40" placeholder="Enter Project Title" required>
						</div>
						<div class="form-group">
 							<input id="domain" name="domain" type="text" maxlength="25" placeholder="Enter domain name ex:cloud,big-data." class="form-control" required>
						</div>
						<div class="form-group">
 							<textarea id="abs" name="abs" rows="7" cols="25" class="form-control" placeholder="Project description( max 200 characters)" minlength="20"  maxlength="200" required></textarea> 
						</div>
						<div class="form-group">
